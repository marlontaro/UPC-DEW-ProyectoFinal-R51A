...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { address: @district.address, gmaps: @district.gmaps, latitude: @district.latitude, longitude: @district.longitude, name: @district.name }
    end
  ...
  test "should update district" do
    put :update, id: @district, district: { address: @district.address, gmaps: @district.gmaps, latitude: @district.latitude, longitude: @district.longitude, name: @district.name }
    assert_redirected_to district_path(assigns(:district))
  end
