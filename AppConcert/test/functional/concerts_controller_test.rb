...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { date: @concert.date, end_time: @concert.end_time, start_time: @concert.start_time, state: @concert.state }
    end
  ...
  test "should update concert" do
    put :update, id: @concert, concert: { date: @concert.date, end_time: @concert.end_time, start_time: @concert.start_time, state: @concert.state }
    assert_redirected_to concert_path(assigns(:concert))
  end
